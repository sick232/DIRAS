...
class Settings(BaseSettings):
    ...
    gemini_generation_max_tokens: int = 2048
    gemini_synthesis_max_tokens: int = 4096
    
    # Grok LLM Configuration (SECONDARY)
    grok_api_key: str = ""
    grok_model: str = "grok-beta"
    grok_temperature: float = 0.3
    grok_generation_max_tokens: int = 2048
    grok_synthesis_max_tokens: int = 4096
    
    # Groq Configuration (TERTIARY)
    groq_api_key: str = ""
    groq_model: str = "mixtral-8x7b-32768-instant"
    groq_temperature: float = 0.3
    groq_generation_max_tokens: int = 2048
    groq_synthesis_max_tokens: int = 4096
    
    # Final synthesis
    final_synthesis_max_tokens: int = 4096
